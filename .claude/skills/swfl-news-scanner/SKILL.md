...
## 8. Logging and QA
Write run_started, per source results, and run_summary rows to Scan Activity Log with run_type swfl_news_scan, per ../swfl-permit-scanner/references/run-logging.md.
