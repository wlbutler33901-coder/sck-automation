...
This reference lists the target municipal permit/zoning portals across Southwest Florida (Lee, Charlotte, Collier, Sarasota, and Manatee counties).

Portals run on a handful of software platforms. Navigation differs by platform - see the Platform Playbook (`references/platform-playbook.md`). Treat the platform column as your cue for how to extract.
...
| Jurisdiction | URL | Platform |
|---|---|---|
| Manatee County | https://aca-prod.accela.com/MANATEE | Accela ACA |
| City of Bradenton | https://aca-prod.accela.com/BRADENTON/Default.aspx | Accela ACA |
| City of Palmetto | https://bsaonline.com/ | BS&A Online |
