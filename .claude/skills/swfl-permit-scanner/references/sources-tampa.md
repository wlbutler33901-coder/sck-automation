...
| 6 | City of St. Petersburg | Click2Gov | https://stpe-egov.aspgov.com/Click2GovBP/index.html | blocked | BLOCKED-SUBSTITUTE | 2026-08-03. Lookup-only, no date search. Tier-3 EXHAUSTED (ArcGIS Geohub 113 svcs, no issued-permits layer; Socrata none; city site only an annual aggregate Utilization Report PDF). NO clean substitute - Pinellas County Accela does NOT cover St. Pete. COVERAGE GAP, NEEDS WILL. Interim: Tier-4 press + Business Observer. |
