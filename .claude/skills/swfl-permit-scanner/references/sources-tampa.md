...
| 6 | City of St. Petersburg | Click2Gov | https://stpe-egov.aspgov.com/Click2GovBP/index.html | blocked | CERTIFIED-LOCAL (entitlements only) + press substitute for commercial | 2026-08-06 recertification OVERTURNS the 2026-08-03 "Tier-3 exhausted" finding. CERTIFIED: ArcGIS MultiFamily_Layer FeatureServer (services2.arcgis.com/9qPLjNtocjo438CJ), no auth, dated multifamily/AH site-plan ENTITLEMENTS - recipe in platform-playbook.md. Ex: "The Eden" 1225 9th Ave N, 20 units, ApplicationReceived+Approved 2026-07-24; "Warehouse Arts (Emerson) Lofts" 558 28th St S, 75 units, AppReceived 2026-06-11; "HSN Headquarters" 2501 118th Ave N, 396 units, Greystar, Approved 2026-04-28. COVERS ENTITLEMENTS, NOT BUILDING PERMITS, and only multifamily/AH - no commercial, industrial, retail or self-storage. Click2Gov remains lookup-only with no date search. Socrata stat.stpete.org is decommissioned; the egis.stpete.org PermitsExternal layer is a frozen archive (max issue date 2021-12-20); DRC/dev-services agenda PDFs were unreachable (Revize renders client-side; Legistar unprovisioned) and would yield entitlements, not permits, anyway. WEDNESDAY RULE: commercial coverage for St. Pete runs as Tier-4 press substitution and MUST log a portal_result row with tier press-substitute, exactly like Tarpon Springs - never a bare coverage_gap. |
